            ...
            <v-row>
                <v-col>
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn
                            :data-unq="`itemSection-button-cancelCreate`"
                            depressed
                            outlined
                            color="#EBEBEB" 
                            class="main-btn"
                        ...
                        <v-btn
                            :data-unq="`itemSection-button-saveCreate`"
                            depressed
                            color="#50ABA3"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.fetchItemSectionForm()
            this.fetchItemSectionDate()
            let self = this
        ...
        methods: {
            ...mapActions([
                ...
                "fetchItemSectionForm",
                "fetchItemSectionDate"
            ]),
            ...
            confirmButton() {
                ...
                this.ConfirmData = {
                    ...
                    text: "Are you sure want to create this Item Section?",
                    urlApi: "/campaign/v1/item_section",
            ...
            regionSelected(d) { //For select region and set id
                ...
                if (d) {
                    d.forEach(e => {
                        this.$store.commit('setItemSectionCreateRegion', e.id)
                    });
                }
            },
            archetypeSelected(d) { //For select archetype and set id
                ...
                if (d) {
                    d.forEach(e => {
                        this.$store.commit('setItemSectionCreateArchetype', e.id)
                    });
                }
            },
